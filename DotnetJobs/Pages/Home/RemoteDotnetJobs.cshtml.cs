...
namespace DotnetJobs.Pages.Home
{
    public class RemoteDotnetJobs : PageModel
	{
		...
		public RemoteDotnetJobs(JobService jobService, ConvertKit convertKit)
		{
		...
		public async Task OnGet([FromQuery] int page = 1)
		{
			...
			// get jobs
			Jobs = await _jobService.GetRemoteJobs(page, take);
